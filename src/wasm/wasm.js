...
* @returns {string}
*/
export function priv_to_pub(priv_key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(priv_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.priv_to_pub(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
* @returns {string}
*/
export function sign(priv_key, hash) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {boolean}
*/
export function verify(pub_key, hash, signature) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
export function get_hash(input) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.get_hash(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
